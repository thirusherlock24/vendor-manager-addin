import { AuthorizationCodePayload, CommonAuthorizationCodeRequest, AuthorizationCodeClient, CcsCredential, Logger, IPerformanceClient, AuthorizeResponse } from "@azure/msal-common/browser";
...
export declare class InteractionHandler {
     ...
     * @param locationHash
     */
    handleCodeResponse(response: AuthorizeResponse, request: AuthorizationUrlRequest): Promise<AuthenticationResult>;
    /**
