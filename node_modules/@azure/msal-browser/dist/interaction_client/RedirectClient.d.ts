import { ServerTelemetryManager, AuthorizeResponse, ICrypto, Logger, IPerformanceClient, InProgressPerformanceEvent } from "@azure/msal-common/browser";
...
export declare class RedirectClient extends StandardInteractionClient {
     ...
     * @param state
     */
    protected handleResponse(serverParams: AuthorizeResponse, serverTelemetryManager: ServerTelemetryManager): Promise<AuthenticationResult>;
    /**
